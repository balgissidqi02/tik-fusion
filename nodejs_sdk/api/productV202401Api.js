...
var ProductV202401Api = /** @class */ (function () {
    function ProductV202401Api(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(ProductV202401Api.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(ProductV202401Api.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(ProductV202401Api.prototype, "defaultHeaders", {
        get: function () {
    ...
    ProductV202401Api.prototype.setDefaultAuthentication = function (auth) {
        this.authentications["default"] = auth;
    };
    ProductV202401Api.prototype.setApiKey = function (key, value) {
        this.authentications[ProductV202401ApiApiKeys[key]].apiKey = value;
    };
    ProductV202401Api.prototype.addInterceptor = function (interceptor) {
     ...
     */
    ProductV202401Api.prototype.ListingSchemasGet = function (categoryIds, xTtsAccessToken, contentType, locale, categoryVersion, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_1, _i, _a, interceptor;
            var _this = this;
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/product/202401/listing_schemas';
