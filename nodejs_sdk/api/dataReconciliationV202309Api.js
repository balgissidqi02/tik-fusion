...
})(DataReconciliationV202309ApiApiKeys = exports.DataReconciliationV202309ApiApiKeys || (exports.DataReconciliationV202309ApiApiKeys = {}));
var DataReconciliationV202309Api = /** @class */ (function () {
    function DataReconciliationV202309Api(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(DataReconciliationV202309Api.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(DataReconciliationV202309Api.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(DataReconciliationV202309Api.prototype, "defaultHeaders", {
        get: function () {
    ...
    DataReconciliationV202309Api.prototype.setDefaultAuthentication = function (auth) {
        this.authentications["default"] = auth;
    };
    DataReconciliationV202309Api.prototype.setApiKey = function (key, value) {
        this.authentications[DataReconciliationV202309ApiApiKeys[key]].apiKey = value;
    };
    DataReconciliationV202309Api.prototype.addInterceptor = function (interceptor) {
     ...
     */
    DataReconciliationV202309Api.prototype.OrdersSyncPost = function (xTtsAccessToken, contentType, shopId, OrderStatusDataExchangeRequestBody, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_1, _i, _a, interceptor;
            var _this = this;
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/data_reconciliation/202309/orders/sync';
    ...
    return DataReconciliationV202309Api;
}());
