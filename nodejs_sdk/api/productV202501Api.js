...
var ProductV202501Api = /** @class */ (function () {
    function ProductV202501Api(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(ProductV202501Api.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(ProductV202501Api.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(ProductV202501Api.prototype, "defaultHeaders", {
        get: function () {
    ...
    ProductV202501Api.prototype.setDefaultAuthentication = function (auth) {
        this.authentications["default"] = auth;
    };
    ProductV202501Api.prototype.setApiKey = function (key, value) {
        this.authentications[ProductV202501ApiApiKeys[key]].apiKey = value;
    };
    ProductV202501Api.prototype.addInterceptor = function (interceptor) {
     ...
     */
    ProductV202501Api.prototype.ComplianceManufacturersSearchPost = function (pageSize, xTtsAccessToken, contentType, pageToken, SearchManufacturersRequestBody, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_1, _i, _a, interceptor;
            var _this = this;
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/product/202501/compliance/manufacturers/search';
     ...
     */
    ProductV202501Api.prototype.ComplianceResponsiblePersonsSearchPost = function (pageSize, xTtsAccessToken, contentType, pageToken, SearchResponsiblePersonsRequestBody, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_2, _i, _a, interceptor;
            var _this = this;
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/product/202501/compliance/responsible_persons/search';
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this._defaultHeaders);
                produces = ['application/json'];
                // give precedence to 'application/json'
