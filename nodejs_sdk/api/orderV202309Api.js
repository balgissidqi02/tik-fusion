...
var OrderV202309Api = /** @class */ (function () {
    function OrderV202309Api(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(OrderV202309Api.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(OrderV202309Api.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(OrderV202309Api.prototype, "defaultHeaders", {
        get: function () {
    ...
    OrderV202309Api.prototype.setDefaultAuthentication = function (auth) {
        this.authentications["default"] = auth;
    };
    OrderV202309Api.prototype.setApiKey = function (key, value) {
        this.authentications[OrderV202309ApiApiKeys[key]].apiKey = value;
    };
    OrderV202309Api.prototype.addInterceptor = function (interceptor) {
     ...
     * @param shopCipher
     */
    OrderV202309Api.prototype.OrdersGet = function (ids, xTtsAccessToken, contentType, shopCipher, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_1, _i, _a, interceptor;
            var _this = this;
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/order/202309/orders';
     ...
     */
    OrderV202309Api.prototype.OrdersSearchPost = function (pageSize, xTtsAccessToken, contentType, sortOrder, pageToken, sortField, shopCipher, GetOrderListRequestBody, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_2, _i, _a, interceptor;
            var _this = this;
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/order/202309/orders/search';
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this._defaultHeaders);
                produces = ['application/json'];
                // give precedence to 'application/json'
