...
var ProductV202405Api = /** @class */ (function () {
    function ProductV202405Api(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(ProductV202405Api.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(ProductV202405Api.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(ProductV202405Api.prototype, "defaultHeaders", {
        get: function () {
    ...
    ProductV202405Api.prototype.setDefaultAuthentication = function (auth) {
        this.authentications["default"] = auth;
    };
    ProductV202405Api.prototype.setApiKey = function (key, value) {
        this.authentications[ProductV202405ApiApiKeys[key]].apiKey = value;
    };
    ProductV202405Api.prototype.addInterceptor = function (interceptor) {
     ...
     * @param shopCipher
     */
    ProductV202405Api.prototype.ProductsDiagnosesGet = function (productIds, xTtsAccessToken, contentType, shopCipher, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_1, _i, _a, interceptor;
            var _this = this;
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/product/202405/products/diagnoses';
     ...
     * @param shopCipher
     */
    ProductV202405Api.prototype.ProductsSeoWordsGet = function (productIds, xTtsAccessToken, contentType, shopCipher, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_2, _i, _a, interceptor;
            var _this = this;
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/product/202405/products/seo_words';
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this._defaultHeaders);
                produces = ['application/json'];
                // give precedence to 'application/json'
     ...
     * @param shopCipher
     */
    ProductV202405Api.prototype.ProductsSuggestionsGet = function (productIds, xTtsAccessToken, contentType, shopCipher, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_3, _i, _a, interceptor;
            var _this = this;
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/product/202405/products/suggestions';
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this._defaultHeaders);
                produces = ['application/json'];
                // give precedence to 'application/json'
