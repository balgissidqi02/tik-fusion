...
})(DataReconciliationV202310ApiApiKeys = exports.DataReconciliationV202310ApiApiKeys || (exports.DataReconciliationV202310ApiApiKeys = {}));
var DataReconciliationV202310Api = /** @class */ (function () {
    function DataReconciliationV202310Api(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(DataReconciliationV202310Api.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(DataReconciliationV202310Api.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(DataReconciliationV202310Api.prototype, "defaultHeaders", {
        get: function () {
    ...
    DataReconciliationV202310Api.prototype.setDefaultAuthentication = function (auth) {
        this.authentications["default"] = auth;
    };
    DataReconciliationV202310Api.prototype.setApiKey = function (key, value) {
        this.authentications[DataReconciliationV202310ApiApiKeys[key]].apiKey = value;
    };
    DataReconciliationV202310Api.prototype.addInterceptor = function (interceptor) {
     ...
     */
    DataReconciliationV202310Api.prototype.OrdersImportPost = function (xTtsAccessToken, contentType, shopCipher, QualityFactoryOrderDataImportAPIRequestBody, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_1, _i, _a, interceptor;
            var _this = this;
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/data_reconciliation/202310/orders/import';
    ...
    return DataReconciliationV202310Api;
}());
